...
router.put('/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, datasource_1.default.getRepository(user_1.User).findOneBy({ id: Number(req.params.id) })];
            case 1:
                user = _a.sent();
...
router.delete('/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                user = req.body;
                return [4 /*yield*/, datasource_1.default.getRepository(user_1.User).delete(req.params.id)];
            case 1:
                result = _a.sent();
                res.send(result);
                return [2 /*return*/];
